                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <div class="row">
                                    <div class="col-md-5">
                                        <h4 class="title">Daftar Klien</h4>
                                        <p class="category">Kelola data klien</p>
                                    </div>
                                    <div class="col-md-7">
                                        <a href="klien-tambah" class="btn btn-info btn-fill btn-wd" style="float: right;">+ Klien</a>
                                    </div>
                                </div>
                                <br>
                            </div>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            foreach ($klien as $klien_item) { ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $klien_item['nama_klien']; ?></td>
                                                    <td><?php echo $klien_item['no_telp']; ?></td>
