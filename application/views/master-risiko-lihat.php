                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_master_risiko" class="form-control border-input" placeholder="Pengiriman material terlambat" value="<?php echo $master_risiko_item['nama_master_risiko']; ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                            </div>
                                        </div>
                                    </div>
