                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_klien" class="form-control border-input" placeholder="Joe Surya" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="no_telp" class="form-control border-input" placeholder="(021) 3510888" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Perusahaan</label>
                                                <input type="text" name="perusahaan" class="form-control border-input" placeholder="PT. Nusantara Mazda" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <input type="text" name="alamat" class="form-control border-input" placeholder="Jl. Suryopranoto No. 77 - 79, Petojo Sel., Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta" required>
                                            </div>
                                        </div>
                                    </div>
