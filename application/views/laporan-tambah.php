                                ...
                                <form name="tambah_pekerjaan" id="tambah_pekerjaan">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Efek</label>
                                                <input type="text" name="efek" class="form-control border-input" placeholder="Pengerjaan ulang dan pekeraan selanjutnya tertunda" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                            </div>
                                        </div>
                                    </div>
