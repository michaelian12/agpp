                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="nilai_s" name="nilai_s" class="form-control border-input" onchange="clearRpn()" oninvalid="this.setCustomValidity('Mohon pilih item dalam daftar')" oninput="setCustomValidity('')" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="nilai_o" name="nilai_o" class="form-control border-input" onchange="clearRpn()" oninvalid="this.setCustomValidity('Mohon pilih item dalam daftar')" oninput="setCustomValidity('')" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="nilai_d" name="nilai_d" class="form-control border-input" onchange="clearRpn()" oninvalid="this.setCustomValidity('Mohon pilih item dalam daftar')" oninput="setCustomValidity('')" required>
                                    ...
                                    <div class="row" id="result">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input id="kategori" type="text" name="kategori" class="form-control border-input" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="nama_mitigasi" type="text" name="nama_mitigasi" class="form-control border-input" placeholder="Jadwal pengiriman dimajukan" list="mitigation_suggestion" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
