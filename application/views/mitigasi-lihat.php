                            ...
                            <div class="content">
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_mitigasi" class="form-control border-input" placeholder="Negosiasi dengan owner" value="<?php echo $mitigasi_item['nama_mitigasi'] ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="button" value="Batal" onclick="window.location.href='<?php echo base_url(); ?>mitigasi'" class="btn btn-default btn-block btn-wd" />
                                        </div>
                                    </div>
