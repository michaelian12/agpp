                                    ...
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <!-- <input type="text" name="nama_risiko" class="form-control border-input" placeholder="Pengiriman material terlambat" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required> -->
                                                        ...
                                                        <?php 
                                                            foreach ($master_risiko as $master_risiko_item) { ?>
                                                                <option value="<?php echo $master_risiko_item['id_master_risiko']; ?>"><?php echo $master_risiko_item['nama_master_risiko']; ?></option>
                                                            <?php }
                                                        ?>
                                                    </select>
                                                    </td>
