                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <?php echo form_open('klien-lihat/'.$klien_item['id_klien']); ?>
                                <form>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="no_telp" class="form-control border-input" placeholder="021-3510888" value="<?php echo $klien_item['no_telp']; ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Perusahaan</label>
                                                <input type="text" name="perusahaan" class="form-control border-input" placeholder="PT. Nusantara Mazda" value="<?php echo $klien_item['perusahaan']; ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <input type="text" name="alamat" class="form-control border-input" placeholder="Jl. Suryopranoto No. 77 - 79, Petojo Sel., Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta" value="<?php echo $klien_item['alamat']; ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                            </div>
                                        </div>
                                    </div>
