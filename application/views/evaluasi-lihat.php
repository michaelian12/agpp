                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Risiko</label>
                                                <input id="nama_risiko" type="text" name="nama_risiko" class="form-control border-input" value="<?php echo $evaluasi_item['nama_risiko']; ?>" placeholder="Pengiriman material terlambat" list="risk_suggestion" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="nilai_s" name="nilai_s" class="form-control border-input" oninvalid="this.setCustomValidity('Mohon pilih item dalam daftar')" oninput="setCustomValidity('')" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input id="nama_penyebab" type="text" name="nama_penyebab" class="form-control border-input" value="<?php echo $evaluasi_item['nama_penyebab']; ?>" placeholder="Aturan red line untuk material impor" list="cause_suggestion" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="nilai_o" name="nilai_o" class="form-control border-input" oninvalid="this.setCustomValidity('Mohon pilih item dalam daftar')" oninput="setCustomValidity('')" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Kontrol</label>
                                                <input id="nama_kontrol" type="text" name="nama_kontrol" class="form-control border-input" value="<?php echo $evaluasi_item['nama_kontrol']; ?>" placeholder="Hasil laporan" list="control_suggestion" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="nilai_d" name="nilai_d" class="form-control border-input" oninvalid="this.setCustomValidity('Mohon pilih item dalam daftar')" oninput="setCustomValidity('')" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="nama_mitigasi" type="text" name="nama_mitigasi" class="form-control border-input" value="<?php echo $evaluasi_item['nama_mitigasi']; ?>" placeholder="Jadwal pengiriman dimajukan" list="mitigation_suggestion" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="button" value="Batal" onclick="window.location.href='<?php echo base_url(); ?>evaluasi'" class="btn btn-default btn-block btn-wd" />
                                        </div>
                                    </div>
