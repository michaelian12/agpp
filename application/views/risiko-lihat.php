                                ...
                                <form>
                                                ...
                                                <?php for ($i=0; $i < count($efek); $i++) { 
                                                    if ($i == 0) { ?>
                                                        <tr id="<?php echo 'row_efek'.$i; ?>">
                                                            <td><input type='hidden' name='id_efek[]' value='<?php echo $efek[$i]['id_efek']; ?>'><input type="text" name="nama_efek[]" class="form-control border-input" placeholder="Pekerjaan selanjutnya tertunda" value="<?php echo $efek[$i]['nama_efek'] ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required></td>
                                                            <td><button type="button" class="btn btn-default btn-wd" style="float: right;" id="tambah_efek">+ Efek</button></td>
                                                        </tr>
                                                    <?php } else { ?>
                                                        <tr id="<?php echo 'row_efek'.$i; ?>">
                                                            <td><input type='hidden' name='id_efek[]' value='<?php echo $efek[$i]['id_efek']; ?>'><input type="text" name="nama_efek[]" class="form-control border-input" placeholder="Pekerjaan selanjutnya tertunda" value="<?php echo $efek[$i]['nama_efek'] ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required></td>
                                                            <td><a href="<?php echo base_url(); ?>efek-hapus/<?php echo $efek[$i]['id_efek']; ?>" type="button" id="<?php echo $i; ?>" class="remove_efek"><i class="ti-trash"></i></a></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
                                                ...
                                                <?php for ($i=0; $i < count($penyebab); $i++) { 
                                                    if ($i == 0) { ?>
                                                        <tr id="<?php echo 'row_penyebab'.$i; ?>">
                                                            <td><input type='hidden' name='id_penyebab[]' value='<?php echo $penyebab[$i]['id_penyebab']; ?>'><input type="text" name="nama_penyebab[]" class="form-control border-input" placeholder="Aturan red line untuk material impor" value="<?php echo $penyebab[$i]['nama_penyebab']; ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required></td>
                                                    ...
                                                    <?php } else { ?>
                                                        <tr id="<?php echo 'row_penyebab'.$i; ?>">
                                                            ...
                                                            <td><a href="<?php echo base_url(); ?>penyebab-hapus/<?php echo $penyebab[$i]['id_penyebab']; ?>" type="button" id="<?php echo $i; ?>" class="remove_penyebab"><i class="ti-trash"></i></a></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
                                    ...
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" name="nama_kontrol" class="form-control border-input" placeholder="Hasil laporan" value="<?php echo $risiko_item['nama_kontrol']; ?>" oninvalid="this.setCustomValidity('Mohon isi kolom ini')" oninput="setCustomValidity('')" required></td>
