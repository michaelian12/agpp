                        ...
                        <div class="card">
                            <div class="header">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <a href="proyek-tambah" class="btn btn-info btn-fill btn-wd" style="float: right;">+ Proyek</a>
                                    </div>
                                </div>
                                <br>
                            </div>
                                        ...
                                        <?php 
                                            foreach ($proyek as $proyek_item) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="proyek-hapus/<?php echo $proyek_item['id_proyek']?>" onclick="return confirm('Anda yakin ingin menghapus data ini? Semua data yang berkaitan dengan data ini akan ikut terhapus.')"><i class="ti-trash"></i></a></td>
                                                </tr>
                                            <?php }
                                        ?>
                                    </tbody>
